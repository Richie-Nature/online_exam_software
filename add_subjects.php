        ...
        <form action="" method="POST">
            ...
            <div class="row mb-4">
                <div class="col-6 col-md-6 ">
                    <h5 class = "text-light"><u>Create Questions</u></h5>
                    <small class="text-light"> <span><strong>2</strong></span> questions set</small>
                    
                </div>
                <div class="col-2">
                    <input type="number" name="no_fields" id="no_fields" max = "50" min = "1" class = "form-control inputs border-primary text-light" placeholder = "No:" onblur = "generateFields();">
                </div>
            </div>
            <hr class="my-2" >
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <textarea name="question<?php ?>" id="que" cols="30" rows="5"  class = "form-control inputs border-success text-light" placeholder ="Enter Question"></textarea>
                            </div>
                            <div class="col-sm-6">
                                <div class="row">
                                    <div class="col-md-1">
